...
public class WeatherForecastController {
    ...
    public String getWeatherForecast() {
        String result = "";
        try {
            URL url = new URL(" https://api.seniverse.com/v3/weather/daily.json?key=SfoQkYWv4FyS_NzJ3&location=nanjing&language=zh-Hans&unit=c&start=0&days=5");//由网址创建URL对象
