package com.example.weatherdisaster.controller;
...
public class weatherDisasterController {
    ...
    public String getWeatherDisaster() {
        String result = "";
        try {
            URL url = new URL("https://api.seniverse.com/v3/weather/alarm.json?key=SfoQkYWv4FyS_NzJ3&location=nanjing");//由网址创建URL对象
